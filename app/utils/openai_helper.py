...
{{
    "items": [
        {{
            ...
            "calories": калорийность (целое число),
            "protein": граммы белка (float),
            "carbs": граммы углеводов (float),
            "fats": граммы жиров (float),
            "fiber": граммы клетчатки (float)
        }}
    ],
    "total_calories": СУММАРНАЯ калорийность ВСЕХ блюд (целое число),
    "total_protein": СУММАРНЫЙ белок (float),
    "total_carbs": СУММАРНЫЕ углеводы (float),
    "total_fats": СУММАРНЫЕ жиры (float),
    "total_fiber": СУММАРНАЯ клетчатка (float),
    "meal_type": "breakfast/lunch/dinner/snack",
    "confidence": уверенность в оценке 0-1,
    "tip": "короткий полезный совет по этому приёму пищи"
}}

Правила:
- ВАЖНО: каждое блюдо/продукт выдели в отдельный элемент items
- Посчитай КБЖУ и клетчатку для КАЖДОГО блюда отдельно
- total_* — это СУММА по всем items
...
- Дай короткий практичный совет в tip
...
Правила:
- Каждое блюдо/продукт на фото — отдельный элемент items
- total_* — сумма по всем items
